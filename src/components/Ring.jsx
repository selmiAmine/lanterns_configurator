...
let colorLerpValue = {x: 0}
  ...
  console.log('hello world this is me', nodes.diamonds001.material.color)

  //  materials.silver.color = new Color(0xfefefe).convertSRGBToLinear(), new Color(0xd28b8b).convertSRGBToLinear()
  //  materials.gold.color = new Color(0xfefefe).convertSRGBToLinear(), new Color(0xd28b8b).convertSRGBToLinear()
  nodes.diamonds001.material.color = new Color(0x39cffe).convertSRGBToLinear()
  nodes.diamonds002.material.color = new Color(0x39cffe).convertSRGBToLinear()
  nodes.diamonds003.material.color = new Color(0x39cffe).convertSRGBToLinear()
  nodes.diamonds004.material.color = new Color(0x39cffe).convertSRGBToLinear()
  ...
  //     scrollTrigger: { trigger: ".second-section",  start: "top bottom", end: "top top", scrub: true, immediateRender: false }
  //     , onUpdate: function() {
  ...
  //               nodes.diamonds004.material.color.lerpColors(new Color(0xffffff).convertSRGBToLinear(), new Color(0x39cffe).convertSRGBToLinear(), colorLerpValue.x)
                  
  //               // }
          
  // }})

      // .to(diamondColor, { diamondColor: new Color(0x39cffe).convertSRGBToLinear() },
      //   {
      //     diamondColor: new Color(0xffffff).convertSRGBToLinear(), scrollTrigger: {
      //       trigger: ".second-section",
      //       ease: "power4.inOut",
      //       start: "top bottom",
      //       end: "top top",
